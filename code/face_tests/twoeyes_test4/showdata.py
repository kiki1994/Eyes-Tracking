...
H5_address = "/disks/disk0/linyuqi/dataset/data_gaze/h5_dataset/h5_loc_grey_37667/h5_txtlist/P00_h5_list.txt"
...
# Turn to 3D
        ...
        return  left_label, right_label, left_headpose, right_headpose
        #return err_lg, err_h

    def __len__(self):
        return len(self.h5_path_list)
h5_list = load_h5_list(H5_address)
a,b,c,d = gaze_dataset(h5_list)
print(a,b,c,d)
