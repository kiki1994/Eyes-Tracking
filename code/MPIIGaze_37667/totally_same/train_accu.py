...
Save_model_address = '/disks/disk0/linyuqi/model/totally_same_lr_nochange/'
BatchSize = 128 
EPOCH = 80
lr_init = 0.0001
count=0
...
#        print(image_right)
       ...
       # print(result_E)
        ...
        if count % 23 == 0:
            ...
            print('num_of_iter = {}      min =({}, {}, {:3.3})     train_ARE_loss={:.13}     train_E_loss= {:.13}     time = {:.2f}  train acc = {:.5}'.format(
