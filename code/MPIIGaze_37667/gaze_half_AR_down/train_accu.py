...
optimizer_AR = torch.optim.Adam(AR_down_model.parameters(),lr=lr_init)
...
#        print(image_right)
        ...
        result_AR = AR_down_model(eye_img_left, eye_img_right,head_pose_left,head_pose_right)       ##output 128 x 6
