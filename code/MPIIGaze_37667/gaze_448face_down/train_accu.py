...
Save_model_address = "/disks/disk0/linyuqi/model/MPIIGaze_37667/448face_1280model_down/"
BatchSize = 128 
EPOCH = 50
lr_init = 0.0001
count=0
...
#train_iteration =np.ceil((37667-2927)/BatchSize)
#test_iteration = np.ceil(2927/BatchSize)
...
#R_down_model = nn.DataParallel(AR_down_model)
#AR_down_model.cuda()
