...
Save_model_address = '/disks/disk0/linyuqi/model/gaze_fullface_2eye_down/'
BatchSize = 128 
EPOCH = 30
vis = visdom.Visdom(env='full_face_AR_down_train')
viz = visdom.Visdom(env='full_face_AR_down_test')
count=0
count_ts=0
