...
optimizer_AR = torch.optim.Adam(AR_model.parameters(),lr=0.0001)
optimizer_E = torch.optim.Adam(E_model.parameters(),lr=0.0001)
...
#        L_E, L_AR, L_AR2 = loss_f(result_AR[:,:3],result_AR[:,3:],label_left,label_right,result_E[:,0],result_E[:,1])
        #L_AR,ang_l,ang_r = loss_f(result_AR[:,:3],result_AR[:,3:],label_left,label_right)
        #label = torch.cat((label_left,label_right),1)
...
#        loss_E,loss_AR,loss_AR2 = loss_f(result_AR[:,:3],result_AR[:,3:],label_left,label_right,result_E[:,0],result_E[:,1])
        L_AR = loss_f(result_AR[:,:3],result_AR[:,3:],label_left,label_right)
        loss = (L_AR )
